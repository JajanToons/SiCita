          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                // onChange={handleInputChange} // Umumnya email tidak diubah sembarangan jika sebagai identifier
                readOnly // Sarankan untuk membuat email read-only atau memiliki alur verifikasi khusus
